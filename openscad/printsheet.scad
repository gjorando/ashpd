...
// 2.3 x1
translate([2*print_margin + 3*(rear_core_height-rear_core_back_reduction_for_plates)/2 + (rear_core_length-rear_core_reduction_length) + (rear_core_height-rear_core_width)/2, 2*print_margin+rear_core_height+(rear_core_width-2*rear_core_back_reduction_for_plates)/2, 0]) rotate([0, 0, 90]) rear_core_2_3();
// 2.3b x1
translate([2*print_margin + rear_core_height/2, 7*print_margin+rear_core_height+2*(rear_core_width-2*rear_core_back_reduction_for_plates)/2, 0]) rotate([0, 0, 90]) rear_core_2_3();
// 2.6 x1
